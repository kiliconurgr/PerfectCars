    ...
    public partial class Vol1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandPortfolio", x => new { x.BrandsId, x.PortfoliosId });
                    table.ForeignKey(
                        name: "FK_BrandPortfolio_Brands_BrandsId",
                        column: x => x.BrandsId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BrandPortfolio_Portfolios_PortfoliosId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ModulsId = table.Column<int>(type: "int", nullable: false),
                    PortfoliosId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModulPortfolio", x => new { x.ModulsId, x.PortfoliosId });
                    table.ForeignKey(
                        name: "FK_ModulPortfolio_Moduls_ModulsId",
                        column: x => x.ModulsId,
                        principalTable: "Moduls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModulPortfolio_Portfolios_PortfoliosId",
                        column: x => x.PortfoliosId,
                        principalTable: "Portfolios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_AspNetUsers_RepresentativeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortfolioVehicle", x => new { x.PortfoliosId, x.VehiclesId });
                    table.ForeignKey(
                        name: "FK_PortfolioVehicle_Portfolios_PortfoliosId",
                        column: x => x.PortfoliosId,
                        principalTable: "Portfolios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PortfolioVehicle_Vehicles_VehiclesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandPortfolio_PortfoliosId",
                table: "BrandPortfolio",
                column: "PortfoliosId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Moduls_BrandId",
                table: "Moduls",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_Moduls_Name_BrandId",
                table: "Moduls",
