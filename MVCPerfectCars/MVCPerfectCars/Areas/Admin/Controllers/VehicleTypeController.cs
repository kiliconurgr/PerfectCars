...
namespace MVCPerfectCars.Areas.Admin.Controllers
{
    ...
    public class VehicleTypesController : Controller
    {
        ...
        public VehicleTypesController(MVCPerfectCarsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,Enabled,DateOfCreation")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id,Enabled,DateOfCreation")] VehicleType vehicleType)
        {
